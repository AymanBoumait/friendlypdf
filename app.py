...
# Sidebar contents
with st.sidebar:
    st.title('Friendly PDF')
    st.markdown('''
    ## About
    What can you do:
    - Make the PDF file your friend.
    - Extract valuable information seamlessly.
    - Navigate through complex PDFs with ease.
    - Answer your questions directly from the document.
    - Save time by automating information retrieval.
